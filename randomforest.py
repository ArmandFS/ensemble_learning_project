...
class randomforest:
    ...
    def rf(self,data,targets,features,which_gain,nTrees,nSamples,nFeatures,maxlevel=5):
        ...
        for i in range(nTrees):
            ...
            # Train classifiers
            classifiers.append(self.tree.make_tree(sample,sampleTarget,features,which_gain,maxlevel,forest=nFeatures))
        return classifiers
